...
const VaccineInformation = ({ selectedVaccine, italizeScientificNames }) => {
    return <div className='position-relative slide-left'>
        ...
        {selectedVaccine.packageInsertLink && <p className='text-warning hover-underline mb-1' onClick={()=>window.open(selectedVaccine.packageInsertLink, '_blank')}>Package Insert <i class="fa-regular fa-file-pdf text-warning hover-underline"></i></p>}
